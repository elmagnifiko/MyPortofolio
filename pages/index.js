...
import deved from "../public/moi.jpeg";
import design from "../public/design.png";
import consulting from "../public/consulting.png";
import Image from "next/image";
import web1 from "../public/agogo.png";
import web2 from "../public/calculator.png";
import web3 from "../public/enval.png";
import web4 from "../public/Todo.png";
import web5 from "../public/shopping.png";
import web6 from "../public/generator.png";
...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Portofolio A.Razak</title>
        <meta name="title" content="A.Razak's Portfolio" />
        <meta name="description" content="Bienvenue sur mon Portfolio ce site contient un bref resumé de mon parcours, mes experiences, mes projet, mon github et quelques uns de mes réseaux sociaux" />
      ...
      <main className=" bg-white   dark: dark:bg-gray-900 px-0 md:px-20 lg:px-30  ">
        <section className="max-w-4xl min-h-screen">
            ...
            <ul className="flex items-center">
              ...
              <li>
                <a
                  ...
                  href="/Cv Abdoul-Razak-Adamou-Bello.png" download="Cv Abdoul-Razak-Adamou-Bello.png"                >
                 Telecharger le CV
                </a>
              </li>
            </ul>
          ...
          <div className="text-center p-10 py-10">
            ...
            Salut, tu peux m'appeler
              <span className="text-teal-600"> A.Razak</span> en abrégé ! Je suis un développeur web avec une vaste expérience dans le développement Web. Autodidacte depuis 2 ans, j'ai ensuite rejoint un codecamp où je crée des sites web qui aident les organisations à relever des défis commerciaux et à répondre à leurs besoins.

              Mon langage principal est{" "}
        ...
        <section className="max-w-4xl">
          <div>
            ...
            Depuis le début de mon parcours en tant que développeur indépendant, j'ai travaillé sur divers projets personnels et collaboré avec des personnes talentueuses pour créer des produits numériques destinés à un usage professionnel et grand public. Je suis très motivé pour collaborer et apporter mes compétences à de nouveaux projets.
        ...
        <footer className="bg-white dark:bg-gray-900">
          <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
            ...
            <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
              <a
                href="https://www.facebook.com/abdoulrazak.adamou.9085"
                className="text-gray-400 hover:text-gray-900 dark:hover:text-white"
              >
                <svg
                  className="w-8 h-8"
